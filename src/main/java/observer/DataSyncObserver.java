...
public class DataSyncObserver extends BaseRegionObserver {
    ...
    public void start(CoprocessorEnvironment env) throws IOException {
        ...
        /*client = new TransportClient(settings)
                .addTransportAddress(new InetSocketTransportAddress(Config.nodeHost, Config.nodePort));*/

//        client = new PreBuiltTransportClient(settings).addTransportAddresses(
//                new InetSocketTransportAddress(InetAddress.getByName(Config.nodeHost), Config.nodePort));
    }
    ...
    private static void testGetPutData(String rowKey, String columnFamily, String column, String value) {
        ...
        for (Map.Entry<byte[], List<Cell>> entry : familyMap.entrySet()) {
            ...
            System.out.println("cf:"+ Bytes.toString(CellUtil.cloneQualifier(cell)));
